...
####################################################
# Modified by Y.Meng, return a list of created env #
####################################################
def get_list_of_envs(
    ...
    # return a list funcs to create envs, mapping between id and tasks
    '''
    For MT10:
    [<NormalizedEnvWrapper<SawyerReachPushPickPlaceEnv instance>>,
    <NormalizedEnvWrapper<SawyerReachPushPickPlaceEnv instance>>,
    <NormalizedEnvWrapper<SawyerReachPushPickPlaceEnv instance>>,
    <NormalizedEnvWrapper<SawyerDoorEnv instance>>,
    <NormalizedEnvWrapper<SawyerDrawerOpenEnv instance>>,
    <NormalizedEnvWrapper<SawyerDrawerCloseEnv instance>>,
    <NormalizedEnvWrapper<SawyerButtonPressTopdownEnv instance>>,
    <NormalizedEnvWrapper<SawyerPegInsertionSideEnv instance>>,
    <NormalizedEnvWrapper<SawyerWindowOpenEnv instance>>,
    <NormalizedEnvWrapper<SawyerWindowCloseEnv instance>>]
    '''
